...
import { listUsers, updateUserRole, updateUser, setUserDisabled, deleteUser } from "@/lib/server/actions/admin/users";
...
export function useAdminUsers() {
  ...
  return {
    ...
    deleteUser: (userId: string) => wrap(deleteUser({ userId })),
  };
}
