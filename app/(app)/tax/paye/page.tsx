...
export default function PAYEReturnPage() {
  ...
  return (
    <PageWrapper>
      <PageHeader
        title={t("PAYE Return {period}", { period: CURRENT_PAYROLL.period })}
      ...
      <div className="bg-white border border-ud-border rounded-2xl p-6 shadow-card">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
          <div className="p-4 rounded-xl bg-ud-primary-50 border border-ud-primary-100">
            <div className="text-xs uppercase tracking-[0.06em] font-semibold text-ud-primary opacity-75">{t("Total Gross")}</div>
          ...
          <div className="p-4 rounded-xl bg-ud-danger-bg border border-ud-danger/20">
            <div className="text-xs uppercase tracking-[0.06em] font-semibold text-ud-danger opacity-75">{t("PAYE Withheld")}</div>
          ...
          <div className="p-4 rounded-xl bg-white border border-ud-border">
            <div className="text-xs uppercase tracking-[0.06em] font-semibold text-ud-text-secondary">{t("Employees")}</div>
          ...
          <div className="p-4 rounded-xl bg-ud-warning-bg border border-ud-warning/20">
            <div className="text-xs uppercase tracking-[0.06em] font-semibold text-ud-warning opacity-75">{t("Status")}</div>
            <div className="mt-2"><Badge variant="warning" size="md">{t("Pending submission")}</Badge></div>
          </div>
        </div>
        ...
        <div className="overflow-x-auto rounded-xl border border-ud-border">
          <table className="w-full text-sm">
            ...
            <tfoot className="bg-ud-primary text-white">
              <tr>
                <td colSpan={2} className="px-4 py-3 font-bold">{t("Total PAYE payable")}</td>
        ...
        <div className="mt-6">
          <DigitalStamp documentName={t("PAYE Return {period}", { period: CURRENT_PAYROLL.period })} onApply={setStamp} applied={stamp} />
        </div>
      </div>
    </PageWrapper>
  );
